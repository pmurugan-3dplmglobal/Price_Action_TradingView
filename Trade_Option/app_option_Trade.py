...
<head>
    ...
    <script>
        ...
        function openTVChart(symbol, contract) {
            ...
            else if (cleanSym === 'SENSEX' || cleanSym.includes('SENSEX')) tvSymbol = "BSE:" + cleanSym;
        ...
        async function checkFyersStatus() {
            try {
                ...
                if (data.authenticated) {
                    ...
                    label.textContent = 'Login required to fetch option charts';
                }
            } catch (e) {
...
<body>
    ...
    <div style="background:#161b22;border:1px solid #30363d;border-radius:8px;padding:10px 16px;margin-bottom:16px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;">
        ...
        <span style="font-size:11px;color:#8b949e;font-weight:600;margin-left:12px;">Port: 6060</span>
...
def api_logs_clear():
    ...
    for lf_cand in [INDEX_LOG_FILE, INDEX_SPOT_LOG_FILE, NIFTY50_LOG_FILE, DAILY_LOG_FILE]:
        if lf_cand:
