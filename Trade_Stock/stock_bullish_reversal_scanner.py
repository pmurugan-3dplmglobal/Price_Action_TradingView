        ...
        for f in as_completed(futures):
            ...
            for name, scanner_func in scanners:
                ...
                if result:
                    ...
                    logging.info(f"  -> MATCH: {symbol} | {result['Pattern']} | {tier_badge} | Entry: {entry_val:.2f} | SL: {result['SL']:.2f} | T1: {result['T1']:.2f} | RR: {result['RR']:.2f} | Parabolic: {result['Parabolic_Score']}")
